...
public class StringConstant {
    ...
    public static final String POWER_STRING_V3 = "Tiêu thụ điện";
    public static final String POWER_STRING_V4 = "Công suất (W)";
    public static final String POWER_STRING_V5 = "Công suất motor";
    public static final String POWER_STRING_V6 = "Công suất tiêu thụ";
    public static final String POWER_STRING_V7 = "Công suất tiêu thụ trung bình:";
    public static final String POWER_STRING_V8 = "Hiệu suất sử dụng điện:";
    public static final String POWER_STRING_V9 = "Công suất tiêu thụ định mức : (làm lạnh)";
    public static final String POWER_STRING_V10 = "điện";
    public static final String POWER_STRING_V11 = "Tổng công suất:";
    public static final String POWER_STRING_V12 = "Công suất điện:";
    public static final String POWER_STRING_V13 = "Điện năng tiêu thụ (kwh/24h)";
